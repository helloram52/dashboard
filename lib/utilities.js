...
var buildCustomerObjectFn = function(customerRevenueMap, customerId, revenue, Country, prodMix, prodType) {
	...
	if(customerRevenueMap.hasOwnProperty(customerId)) {
		...
		if(customerRevenueMap[customerId].hasOwnProperty(Country)) {
			...
			if(customerRevenueMap[customerId][Country].hasOwnProperty(prodMix)) {
				...
				prodTypeRevenue = customerRevenueMap[customerId][Country][prodMix][prodType];
				customerRevenueMap[customerId][Country][prodMix][prodType] = revenue + prodTypeRevenue;
				
				}
				else {

					customerRevenueMap[customerId][Country][prodMix][prodType] = revenue;	
				}
			}
			else {
		...
		if(revenueMaps.hasOwnProperty(busUnit)) {
			...
			if(revenueMaps[busUnit].hasOwnProperty(year)) {
				...
				if(revenueMaps[busUnit][year].hasOwnProperty(month)) {
					...
					this.buildCustomerObject(customerRevenueMap,customerId, revenue, Country, prodMix, prodType);
			...
			revenueMaps[busUnit][year][month][customerId][Country][prodMix][prodType] = revenue;
		}
	}
